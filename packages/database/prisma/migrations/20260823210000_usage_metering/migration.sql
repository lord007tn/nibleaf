...
CREATE TABLE "usage_ingest_checkpoint" (
  ...
  "enqueueAttemptCount" INTEGER NOT NULL DEFAULT 0,
  "writtenAt" TIMESTAMP(3),
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" TIMESTAMP(3) NOT NULL,
  CONSTRAINT "usage_ingest_checkpoint_pkey" PRIMARY KEY ("id")
);
...
CREATE INDEX "usage_ingest_checkpoint_organizationId_writtenAt_idx" ON "usage_ingest_checkpoint"("organizationId", "writtenAt");
CREATE INDEX "usage_ingest_project_pending_period_idx" ON "usage_ingest_checkpoint"("projectId", "writtenAt", "firstOccurredAt", "lastOccurredAt");
...
ALTER TABLE "usage_ingest_checkpoint" ADD CONSTRAINT "usage_ingest_checkpoint_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "usage_ingest_checkpoint" ADD CONSTRAINT "usage_ingest_checkpoint_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "project"("id") ON DELETE CASCADE ON UPDATE CASCADE;
