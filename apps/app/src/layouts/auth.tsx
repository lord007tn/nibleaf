    ...
    <main className="grid min-h-screen lg:grid-cols-2">
      <div className="relative hidden flex-col justify-between bg-primary p-12 text-primary-foreground lg:flex">
        <div className="flex items-center gap-2.5">
          <span className="grid size-8 place-items-center rounded-lg bg-primary-foreground/15 font-semibold">✎</span>
          <span className="font-semibold text-lg tracking-tight">Plume</span>
        </div>
        <div>
          <h2 className="font-semibold text-3xl leading-tight tracking-tight">Beautiful docs, on your own infrastructure.</h2>
          <p className="mt-3 max-w-md text-primary-foreground/80 text-sm leading-relaxed">
            The open-source documentation platform. Write in Markdown, publish a fast searchable site, self-host with Docker.
          </p>
        </div>
      ...
      <div className="grid place-items-center bg-background px-6 py-12">
        <div className="w-full max-w-sm">
          <div className="mb-7 text-center lg:hidden">
            <span className="font-semibold text-2xl tracking-tight">Plume</span>
          </div>
