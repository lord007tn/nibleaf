...
export const MARKETING_SITEMAP: MarketingSitemapEntry[] = [
  ...
  { path: '/ar/guides', lastmod: '2026-09-11' },
  { path: '/cloud', lastmod: '2026-07-13' },
  { path: '/pricing', lastmod: '2026-09-11' },
  ...
  { path: '/compare/nibleaf-vs-mintlify', lastmod: '2026-09-11' },
  { path: '/compare/nibleaf-vs-gitbook', lastmod: '2026-09-11' },
  { path: '/compare/nibleaf-vs-docusaurus', lastmod: '2026-09-11' },
  { path: '/alternatives/mintlify', lastmod: '2026-09-11' },
  { path: '/alternatives/gitbook', lastmod: '2026-09-11' },
  { path: '/alternatives/readme', lastmod: '2026-09-11' },
