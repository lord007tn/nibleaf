...
The managed cloud is in [free beta](/sign-up). A full-stack Compose design also exists, but its public repository and container package currently reject anonymous access. Check the [distribution status](/self-hosting) before planning a self-hosted deployment.
