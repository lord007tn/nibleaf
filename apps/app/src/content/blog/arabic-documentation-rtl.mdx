...
For an Arabic version of this checklist, read [كيف تنشر وثائق منتج بالعربية](/blog/arabic-technical-documentation-rtl-checklist). You can [start on the hosted beta](/sign-up) or follow the public [self-hosting guide](/self-hosting).
