...
| **Nibleaf** | Notion-style web editor that round-trips plain Markdown | Built-in Orama full-text + fuzzy, Arabic tokenizer | Per-language page trees, first-class RTL, hreflang | Free cloud beta or public Docker Compose release | Mixed teams with non-developer writers; Arabic/English docs |
