...
export const Route = createFileRoute('/terms')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'The terms governing your use of Plume.' },
    ],
  }),
  component: TermsPage,
});
      ...
      <main className="mx-auto max-w-3xl px-6 py-20">
        ...
        <div className="mt-10 space-y-8 text-muted-foreground leading-relaxed">
          <section>
            ...
            <p className="mt-3">
              By accessing or using Plume (the "Service") you agree to be bound by these Terms of
              Service. If you do not agree to these terms, do not use the Service. This is placeholder
              copy — replace it with terms reviewed by your own legal counsel before going live.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              Plume is distributed under the MIT license. The license that ships with the source code
              governs your rights to use, copy, modify, and distribute the software. Nothing in these
              terms limits the rights granted to you under that open-source license.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              When you self-host Plume, you are solely responsible for your own infrastructure,
              configuration, data, security, and compliance. The Service is provided "as is" without
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              distribute unlawful, harmful, or malicious content. Replace this section with the specific
              policies that apply to your deployment.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              liable for any claim, damages, or other liability arising from the use of the Service.
            </p>
          </section>
